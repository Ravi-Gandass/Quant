...
<body>
    ...
    <section id="product1" class="section-p1"> 
        <h2 id ="shopping">Featured Products</h2>
        ...
        <div class="pro-container">
            <div class="pro">
                ...
                <a href="#"><i class="bi bi-cart-dash-fill cart"></i></a>
            </div>
            <div class="pro">
    ...
    <section id="sm-banner" class="section-p1">
        <div class="banner-box">
            ...
            <span>The best classic dress is on sale at Quant</span>
